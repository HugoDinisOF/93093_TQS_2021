...
public class AddressResolver {
    ...
    public Address findAddressForLocation(double latitude, double longitude) throws URISyntaxException, IOException, ParseException, org.json.simple.parser.ParseException, BadArrayIndex {
        ...
        try {
            ...
            address = (JSONObject) ((JSONArray) obj.get("locations")).get(0);
        }catch (Exception e){
